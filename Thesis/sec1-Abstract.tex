...
A discovery is made with regard to the orbital parameters $p$, $e$, and $x$ (the semi-latus rectum or ``size" of the orbit, the eccentricity or non-circularity of the orbit, and the inclination angle from the equatorial plane at $\theta=\pi/2$ respectively); there is an almost linear relationship between them in resonant conditions.
